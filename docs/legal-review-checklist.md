...
so whoever operates Miravelt (or a lawyer engaged to review it) has one place
listing exactly what's decided, what's implemented, and what's still an open
decision before Miravelt is submitted to an app store or opened to real users
...
- [ ] Confirm whether Google's API/branding usage (parsing "Google Pay"
      ...
      `TERMS_OF_SERVICE.md`'s "What Miravelt is (and isn't)" section already
      states (Miravelt is not affiliated with Google Pay).
