...
/// Attaches `X-Miravelt-API-Key` to every request and `Authorization: Bearer`
...
class AuthInterceptor extends Interceptor {
  AuthInterceptor({
    ...
    required this._onSessionExpired,
          ...
          ..options.headers['X-Miravelt-API-Key'] = AppConfig.apiKey;
  ...
  Future<void> onError(DioException err, ErrorInterceptorHandler handler) async {
    ...
    final alreadyRetried = err.requestOptions.extra['miravelt_retried'] == true;
    ...
    try {
      ...
      retryOptions.extra['miravelt_retried'] = true;
      final accessToken = await _tokenStorage.readAccessToken();
